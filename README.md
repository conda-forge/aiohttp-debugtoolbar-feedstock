...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6940&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiohttp-debugtoolbar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiohttp-debugtoolbar` can be installed with:

```
conda install aiohttp-debugtoolbar
```

It is possible to list all of the versions of `aiohttp-debugtoolbar` available on your platform with:
